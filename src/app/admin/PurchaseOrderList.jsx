...
export default function PurchaseOrderList() {
  ...
  const filteredOrders = orders.filter((o) => {
    const matchesSearch =
      (o.vendor_name && o.vendor_name.toLowerCase().includes(search.toLowerCase())) ||
    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.currentTarget.style.boxShadow = "0 4px 14px rgba(180,148,72,0.4)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.background = "#b49448";
              e.currentTarget.style.transform = "translateY(0)";
              e.currentTarget.style.boxShadow = "0 2px 8px rgba(180,148,72,0.3)";
            }}
          >
          ...
          <div style={{ position: "relative", flex: 2, minWidth: "260px" }}>
            <Search
              ...
              style={{
                ...
                transform: "translateY(-50%)", color: "#b49448", pointerEvents: "none",
              }}
            />
            <input
              type="text"
              ...
              style={{ ...inputBase, width: "100%", paddingLeft: "38px", paddingRight: "12px" }}
            />
          </div>
        ...
        <div style={{
          ...
          border: "1px solid #d4c9b0",
          borderTopWidth: "3px",
          boxShadow: "0 2px 4px rgba(0,0,0,0.04), 0 6px 20px rgba(0,0,0,0.28)",
          overflow: "hidden",
          overflowX: "auto",
        }}>
          <table style={{
            ...
            <thead>
              <tr style={{ background: "#0f1a2e" }}>
                {["PO Number", "Date", "Vendor", "Amount", "Action"].map((col, i) => (
                  <th key={col} style={{
                    padding: "12px 18px",
                    fontSize: "9.5px",
                    fontWeight: 700,
              ...
              {loading ? (
                <tr>
                  <td colSpan="5" style={{
                    ...
                    color: "#b49448", fontFamily: "'DM Sans', sans-serif",
                    fontSize: "13px", letterSpacing: "1px", textTransform: "uppercase",
                  }}>
                    <Loader2 size={16} style={{ display: "inline", marginRight: "8px", verticalAlign: "middle" }} className="animate-spin" />
                    Loading...
                  </td>
                </tr>
                ...
                filteredOrders.map((po) => (
                  ...
                  >
                    ...
                    <td style={{ padding: "13px 18px", color: "#666", fontSize: "13px" }}>
                    ...
                    <td style={{ padding: "13px 18px", textAlign: "center" }}>
                      <button
                        ...
                        onClick={() => navigate(`/admin/purchase-order/${po.id}`)}
                        style={{
                          color: "#b49448",
                          background: "none",
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.background = "rgba(180,148,72,0.08)";
                          e.currentTarget.style.borderColor = "#b49448";
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.background = "none";
                          e.currentTarget.style.borderColor = "rgba(180,148,72,0.35)";
                        }}
                      >
                        View
                      </button>
